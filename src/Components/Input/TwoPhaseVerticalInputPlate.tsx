...
const TwoPhaseVerticalInputPlate:React.FC<Props> = ({onInputSubmit, selectedSeparator}) => {
    const validationTwoPhase = Yup.object().shape({
        ...
        tr: Yup.number().required("Время удержания обязательно").oneOf([1,2,3]), 
...
export default TwoPhaseVerticalInputPlate;
