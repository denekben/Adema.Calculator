...
const ThreePhaseVerticalSolution:React.FC<Props>  = ({inputData}) => {
    ...
    return(
        <>
            ...
            <div className="mb-8 p-6 bg-gray-50 rounded-lg shadow-md max-w-full mx-auto">
            ...
            <div className="mb-8 p-6 bg-gray-50 rounded-lg shadow-md w-full mx-auto">
                <h3 className="text-xl font-semibold mb-4 text-center">Liquid droplet removal</h3>
                <div className=" mb-8 p-6 flex flex-col justify-center items-center bg-gray-50 rounded-lg shadow-md w-full">
                    <div className="flex flex-col justify-center items-center w-full">
                        ...
                        <div className=" mb-8 flex flex-col justify-center items-center bg-gray-50 rounded-lg shadow-md w-full">
                        ...
                        <div className="flex flex-col mb-8 justify-center items-center bg-gray-50 rounded-lg shadow-md w-full">
                            <div className='mb-4 mt-4'>
                                <Latex>{`$$V_t=0.0119*[\\frac{(ρ_l-ρ_g)*d_m}{ρ_g * C_D}]^{1/2}$$`}</Latex>
                            </div>
                            <div className='mb-4'>
                ...
                <div className="p-6 mb-8 flex flex-col justify-center items-center bg-gray-50 rounded-lg shadow-md w-full">
                    <div className='mb-4'>
            ...
            <table className="min-w-full bg-gray-50 text-center rounded-lg max-w-full shadow-md">
                <thead>
                    <tr>
